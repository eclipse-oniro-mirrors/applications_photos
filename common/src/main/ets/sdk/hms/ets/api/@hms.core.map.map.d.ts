...
import type mapCommon from '@ohos.core.map.mapCommon';
...
declare namespace map {
  ...
  class MapComponentController {
    ...
    /**
     * Sets the frame rate.
     * @param { number } fps  - Frames per second. The value ranges from 1 to 60.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 6.0.0(20)
     ...
     * Note that if multiple markers are passed, the positions of the markers must be the same.
     *
     * @param { CameraUpdate } update - Indicates the new camera state.
     ...
     * After this method is used, the map is zoomed based on the set screen coordinates.
     * Abnormal values are processed as no response.
     *
    ...
    /**
     * Set the display sequence of map elements. The elements are displayed in ascending order.
     * That is, the later overlays overwrite the previous overlays..
     *
     * @param {Array<mapCommon.MapElementType>} types - Indicates the map element type.
     * @throws { BusinessError } 401 - Invalid input parameter.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
    ...
    /**
     * Turn the contour layer on or off.
     * Abnormal values are handled according to the default values.
     *
     * @param { boolean } enabled - Indicates whether to enable the contour layer.
     ...
     * Add tile overlay.
     *
     * @param { mapCommon.TileOverlayParams } params - Indicates the tile overlay parameter.
     * @returns { TileOverlay } Return TileOverlay.
     * @throws { BusinessError } 401 - Invalid input parameter.
     * @throws { BusinessError } 1002601001 - The object to be operated does not exist.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     ...
     * @since 5.0.3(15)
     */
    addTileOverlay(params: mapCommon.TileOverlayParams): TileOverlay;

    /**
     * Return the logo zoom scale.
     *
     * @returns { number } Return the logo zoom scale.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
    ...
    /**
     * Returns the switch for whether the sphere effect is on.
     *
     * @returns { boolean } Returns the switch for whether the sphere effect is on.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
    ...
    /**
     * Set the switch for whether the sphere effect is on.
     *
     * @param { boolean } enabled - Indicates the switch for whether the sphere effect is on.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
    ...
    /**
     * Set the logo zoom scale, and the range is [0.8,1].
     *
     * @param { number } logoScale - Indicates the logo zoom scale.
     * @throws { BusinessError } 401 - Invalid input parameter.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
    ...
    /**
     * Turn the indoor map on or off.
     * Abnormal values are handled according to the default values.
     *
     * @param { boolean } enabled - Indicates whether to enable the indoor map.
    ...
    /**
     * Return whether to display the indoor map.
     *
     * @returns { boolean } Return the switch to display the indoor map.
     * @throws { BusinessError } 801 - Capability not supported. Failed to call the API due to limited device capabilities.
     *
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
    ...
    /**
     * Switch to the specified indoor building floor.
     *
     * @param { string } buildingId - Indicates the id of building.
     * @param { string } floorName - Indicates the name of building floor.
     * @throws { BusinessError } 801 - Capability not supported. Failed to call the API due to limited device capabilities.
     *
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
    ...
    /**
     * Set the position of the floor switch control.
     *
     * @param { mapCommon.MapPoint } point - Indicates the position of the floor switch control.
     * @throws { BusinessError } 801 - Capability not supported. Failed to call the API due to limited device capabilities.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
  ...
  interface Marker extends BaseOverlay {
     ...
     *
     * @param { boolean } visible - Indicates whether to display the annotation.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.1.1(19)
    ...
    /**
     * Return whether the annotation is visible.
     *
     * @returns { boolean } Return whether the annotation is visible.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.1.1(19)
  ...
  interface MapPolyline extends BaseOverlay {
     ...
     * If isTextureMappingUsed is false, recommended that texture has no background color (use transparent color).
     *
     * @param { ResourceStr | image.PixelMap } customTexture - The custom texture.
     * @param { boolean } isTextureMappingUsed - Whether to use the mapping mode for texture drawing. By default is false.
     * @returns { Promise<void> }
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
    ...
    /**
     * Set the custom texture indexes.
     * @param { number[] } customTextureIndexes - The custom texture indexes corresponding to each point.
     * @returns { Promise<void> }
     * @throws { BusinessError } 401 - Invalid input parameter.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
   ...
   * @since 5.0.0(12)
   */
  function newLatLngBounds(bounds: mapCommon.LatLngBounds, width: number, height: number,
    padding: number): CameraUpdate;

  /**
   * Create a CameraUpdate object that contains the latitude and longitude range and the padding of four directions.
   *
   * @param { mapCommon.LatLngBounds } bounds - Indicate the LatLngBounds
   * @param { mapCommon.Padding } padding - Indicate the distance between the map area and the border, in pixels.
   * @returns { CameraUpdate } Return CameraUpdate object.
   * @throws { BusinessError } 401 - Invalid input parameter.
   * @syscap SystemCapability.Map.Core
   * @stagemodelonly
   ...
   * @since 5.0.1(13)
   */
  function newLatLngBounds(bounds: mapCommon.LatLngBounds, padding: mapCommon.Padding): CameraUpdate;
   ...
   * @since 4.1.0(11)
   */
  function convertCoordinate(fromType: mapCommon.CoordinateType, toType: mapCommon.CoordinateType,
   ...
   * @since 5.0.0(12)
   */
  function convertCoordinateSync(fromType: mapCommon.CoordinateType, toType: mapCommon.CoordinateType,
    location: mapCommon.LatLng): mapCommon.LatLng;


  /**
   * Determine whether the coordinates need to be corrected based on the input coordinate system and coordinates.
   * If the coordinates need to be corrected, the corrected coordinates are returned to correspond to the coordinates
   * of the map data.
   *
   * Note:
   * 1.If the GCJ02 coordinate system is entered and the map data uses the WGS84 coordinate system,
   * the api will return the WGS84 coordinate system and original coordinates, which indicating that you should use
   * the WGS84 coordinate system.
   * 2.If the GCJ02 coordinate system is entered and the map data uses the GCJ02 coordinate system,
   * the api will return the GCJ02 coordinate system and original coordinates.
   * 3.If the WGS84 coordinate system is entered and the map data uses the GCJ02 coordinate system,
   * the api will convert the WGS84 coordinate system to GCJ02 coordinate system.
   * 4.If the WGS84 coordinate system is entered and the map data uses the WGS84 coordinate system,
   * the api will return the WGS84 coordinate system and original coordinates.
   *
   * @param {common.Context} context - The context of an ability.
   * @param {Array<mapCommon.CoordinateLatLng>} locations - Input coordinate system and coordinates.
   * @returns {Promise<Array<mapCommon.CoordinateLatLng>>} Return the corrected coordinates.
   * @throws { BusinessError } 401 - Invalid input parameter.
   * @throws { BusinessError } 1002600013 - The current routing location is unknown. Try again later..
   * @syscap SystemCapability.Map.Core
   * @stagemodelonly
   * @atomicservice
   * @since 5.0.0(12)
   */
  function rectifyCoordinate(context: common.Context,
    locations: Array<mapCommon.CoordinateLatLng>): Promise<Array<mapCommon.CoordinateLatLng>>;
  ...
  interface ClusterOverlay {
    ...
    /**
     * Listen cluster marker click event.
     *
     * @param { 'markerClusterClick' } type
     * @param { Callback<MarkerClusterInfo> } callback - Indicates the listener when click the cluster marker.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
    ...
    /**
     * Cancel listening cluster marker click event.
     *
     * @param { 'markerClusterClick' } type
     * @param { Callback<MarkerClusterInfo> } [callback] - Cancel the listener when click the cluster marker.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
  ...
  interface MapEventManager {
    ...
    /**
     * Listen to the indoor map enter event.
     *
     * @param {'indoorMapEnter'} type
     * @param {Callback<IndoorMapInfo>} callback - Indicates the listener when indoor map enter.
     * @throws { BusinessError } 801 - Capability not supported. Failed to call the API due to limited device capabilities.
     *
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
    ...
    /**
     * Cancel listening the indoor map enter event.
     *
     * @param {'indoorMapEnter'} type
     * @param {Callback<IndoorMapInfo>} [callback] - Cancel listening the indoor map enter event.
     * @throws { BusinessError } 801 - Capability not supported. Failed to call the API due to limited device capabilities.
     *
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
    ...
    /**
     * Listen to the indoor map exit event.
     *
     * @param {'indoorMapExit'} type
     * @param {Callback<void>} callback - Indicates the listener when indoor map exit.
     * @throws { BusinessError } 801 - Capability not supported. Failed to call the API due to limited device capabilities.
     *
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
    ...
    /**
     * Cancel listening the indoor map exit event.
     *
     * @param {'indoorMapExit'} type
     * @param {Callback<void>} [callback] - Cancel listening the indoor map exit exit.
     * @throws { BusinessError } 801 - Capability not supported. Failed to call the API due to limited device capabilities.
     *
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
  ...
  interface MarkerClusterInfo {
    ...
    /**
     * Indicates cluster items contained in the marker.
     *
     * @type { Array<mapCommon.ClusterItem> }
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
     */
    clusterItems: Array<mapCommon.ClusterItem>;
  }
   ...
   * @since 5.0.3(15)
   */
  interface TileOverlay extends BaseOverlay {
    /**
     * Set the transparency of the tile overlay.
     *
     * @param { number } transparency - Indicates the transparency of the tile overlay.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
    ...
    /**
     * Set whether the tile overlay is faded in.
     *
     * @param { boolean } fadeIn - Indicates whether the tile overlay is faded in.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
     ...
     *
     * @returns { number } Return the transparency of the tile overlay.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
    ...
    /**
     * Return whether the tile overlay is faded in.
     *
     * @returns  { boolean } Return whether the tile overlay is faded in.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
  ...
  /**
   * The indoor map information.
   *
   * @typedef IndoorMapInfo
   * @syscap SystemCapability.Map.Core
   * @stagemodelonly
   * @atomicservice
   * @since 5.1.1(19)
  ...
  interface IndoorMapInfo {
    ...
    /**
     * Indicates array of building floor name.
     *
     * @type { string[] }
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
    ...
    /**
     * Indicates array of building floor order.
     *
     * @type { number[] }
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
    ...
    /**
     * Indicates current building floor order.
     *
     * @type { string }
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
