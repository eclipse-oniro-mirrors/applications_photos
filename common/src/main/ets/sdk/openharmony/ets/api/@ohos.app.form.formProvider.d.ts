...
declare namespace formProvider {
   ...
   * Client to communication with FormManagerService.
   *
   * @param { formInfo.FormInfoFilter } filter - Indicates the requirements the forms that the formInfos belong to have
   *     to meet.
   ...
   * Client to communication with FormManagerService.
   *
   * @param { formInfo.FormInfoFilter } [filter] - Indicates the requirements the forms that the formInfos belong to
   *     have to meet.
   ...
   *
   * @throws { BusinessError } 801 - Capability not supported.function openFormEditAbility can not work correctly due
