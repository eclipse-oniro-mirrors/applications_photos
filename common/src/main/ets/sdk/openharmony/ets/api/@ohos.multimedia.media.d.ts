...
declare namespace media {
   ...
   * @since 12
   */
  type AVPlayerState = 'idle' | 'initialized' | 'prepared' | 'playing' | 'paused' | 'completed' | 'stopped' | 'released'
    | 'error';
  ...
  interface AVPlayer {
     ...
     * Supported states: initialized.
     * @returns { Promise<void> } A Promise instance used to return when operation completed.
     * @throws { BusinessError } 202 - Called from Non-System applications. Return by promise.
     * @throws { BusinessError } 5400102 - Operation not allowed. Return by promise.
     * @throws { BusinessError } 5400104 - Time out. Return by promise.
     * @syscap SystemCapability.Multimedia.Media.AVPlayer
     * @systemapi
