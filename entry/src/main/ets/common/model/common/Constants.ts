...
export class Constants {
    ...
    static readonly SCROLL_BAR_VISIBLE_THRESHOLD: number = deviceInfo.deviceType == 'phone' || deviceInfo.deviceType == 'default' ? 7 : 29;
    static readonly GRID_SCROLL_BAR_VISIBLE_THRESHOLD: number = deviceInfo.deviceType == 'phone' || deviceInfo.deviceType == 'default' ? 7 : 36;
