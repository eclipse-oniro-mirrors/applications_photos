...
#include "HveUpdOperAreaWithCrop2Prev.h"

HveUpdOperAreaWithCrop2Prev::HveUpdOperAreaWithCrop2Prev(HveTimeline *timeline, const HmcUid &assetUid,
...
HveUpdOperAreaWithCrop2Prev::~HveUpdOperAreaWithCrop2Prev() {}

bool HveUpdOperAreaWithCrop2Prev::CheckAnimation()
{
    auto hveAsset = m_timeline->GetHveAsset(m_assetUid);
    return !hveAsset->GetInPreviewMode();
}

PreviewAssetAnimationArea HveUpdOperAreaWithCrop2Prev::PkgParams()
{
    auto hveAsset = m_timeline->GetHveAsset(m_assetUid);
